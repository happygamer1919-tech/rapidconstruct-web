...
| promo + roofPage + home.seo RU price edits (RC-402: dropped "цена 160 лей/м² заморожена на 2026 год" from both promo bars; "160"→"1100" in roofPage seo title/description/priceChip + 2 roof FAQ + the general pricing FAQ + home meta + llms.txt) | 2026-07-26 | NEEDS NATIVE REVIEW before launch. No NEW strings — existing RU edited: freeze clause removed, roof floor now 1100 лей/м² (owner's real number); "крышу"/"кровлю" register kept as-is. |
