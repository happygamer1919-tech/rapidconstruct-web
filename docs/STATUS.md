...
| **B4 🚨 LAUNCH-BLOCKING** | **Q-10 — configurator bands are a COMPETITOR's live prices** | **The configurator's "placeholder" bands 450/550/800 lei/m² are Imperlux's LIVE PUBLISHED prices** (`imperlux.md/acoperisuri/preturi`: țiglă metalică 450–900, shingle 550–1100, rocă vulcanică 800–1450) — a **named competitor's real numbers, not neutral placeholders**. **The configurator MUST NOT go live with these, under any circumstances** — gate added to `docs/LAUNCH-CHECKLIST.md`. The client's only public price is "160 lei/m² înghețat 2026" for acoperiș — **below** the market manoperă-only rate (180–280 lei/m²), so scope is unclear and it can't be used as a band. **No public fence prices.** Owner must supply real, own bands. Roof-calculator ceramic entries (Creaton 57/58) still pending too. | **Max** |
